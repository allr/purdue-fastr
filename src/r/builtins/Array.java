...
public class Array {
    ...
    public static final CallFactory FACTORY = new CallFactory() {
        ...
        public RNode create(ASTNode call, RSymbol[] names, RNode[] exprs) {
            ...
            return new Impl(call, names, exprs, a.providedParams, a.paramPositions);
        }
    };

    /**
     * Implementation of the array builtin function.
     * 
     * Here possible optimizations include special constructors for the versions where some of the
     * arguments are statically known, like the dimensions, or the dimension names.
     */
    protected static class Impl extends BuiltIn {

        private final boolean[] provided;
        private final int[] paramPositions;

        public Impl(ASTNode orig, RSymbol[] argNames, RNode[] argExprs, boolean[] providedArgs, int[] paramPositions) {
