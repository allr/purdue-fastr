    ...
    public static final CallFactory FACTORY = new CallFactory() {
        ...
        @Override public RNode create(ASTNode call, RSymbol[] names, RNode[] exprs) {
            ...
            if (provided[IFROM] && provided[ITO]) {
                    ...
                    if (provided[IBY]) {
                        ...
                        return new BuiltIn(call, names, exprs) {
                            ...
                            @Override public final RAny doBuiltIn(Frame frame, RAny[] args) {
                                ...
                                if (n > Integer.MAX_VALUE) { throw RError.getByTooSmall(ast); }
                    ...
                    if (provided[ILENGTH_OUT]) {
                        ...
                        return new BuiltIn(call, names, exprs) {
                            ...
                            @Override public final RAny doBuiltIn(Frame frame, RAny[] args) {
                                ...
                                if (lengthOut == 2) { return Combine.genericCombine(null, new RAny[]{argfrom, argto}); }
                                ...
                                return Combine.genericCombine(null, vec);
                            }
                        };
                    }
                }
                ...
                if (exprs.length == 1) {
                    if (provided[IALONG_WITH]) { return new BuiltIn.BuiltIn1(call, names, exprs) {
                    ...
                    if (provided[IFROM]) { return new BuiltIn.BuiltIn1(call, names, exprs) {
                    ...
                    if (provided[ILENGTH_OUT]) { return new BuiltIn.BuiltIn1(call, names, exprs) {
