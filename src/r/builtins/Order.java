...
final class Order extends CallFactory {

    static final CallFactory _ = new Order("order", new String[]{"...", "na.last", "decreasing"}, new String[]{});
    ...
    public static final class DoubleComparator extends ElementsComparator {
        final RDouble v;
    ...
    public static final class IntComparator extends ElementsComparator {
        final RInt v;
    ...
    public static final class LogicalComparator extends ElementsComparator {
        final RLogical v;
    ...
    public static final class StringComparator extends ElementsComparator {
        final RString v;
