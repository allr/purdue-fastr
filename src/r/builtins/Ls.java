...
final class Ls extends CallFactory {
    ...
    @Override public RNode create(ASTNode call, RSymbol[] names, RNode[] exprs) {
        ...
        if (ia.provided("pattern")) { throw Utils.nyi(); }
        ...
        return new Builtin(call, names, exprs) {
            ...
            public RAny doBuiltIn(Frame frame, RAny[] args) {
                ...
                boolean includeHidden = posAllNames == -1 ? false : parseAllNames(args[posAllNames]);
                String[] varNames = Convert.symbols2strings(envir.ls(includeHidden));
