            ...
            try {
                ...
                if (CAN_BYPASS_TRUFFLE) {
                   ...
                   if (argExprs.length == 1) {
                       f = new FunctionCall(ast, closureExpr, argNames, argExprs) {
                            ...
                            public Object execute(RContext context, Frame callerFrame) {
                                ...
                                return tgt.trivialCall(context, argExprs[0].execute(context, callerFrame));
                            }
                   ...
                   if (argExprs.length == 2) {
                       f = new FunctionCall(ast, closureExpr, argNames, argExprs) {
                            ...
                            public Object execute(RContext context, Frame callerFrame) {
                                RClosure tgt = (RClosure) closureExpr.execute(context, callerFrame);
                                return tgt.trivialCall(context, argExprs[0].execute(context, callerFrame), argExprs[1].execute(context, callerFrame));
                            }
