...
public class fastr {
    ...
    static class ClassPatcher implements Translator {
        ...
        public void onLoad(ClassPool pool, String classname) throws NotFoundException, CannotCompileException {
            ...
            if (isNode(cls)) {
                ...
                if (! hasCopyOrMoveConstructor(cls))
                    injectCopyOrMoveConstructor(cls);
                else
                    println("    already contains copy or move constructor.");
         ...
         */
        protected boolean hasCopyOrMoveConstructor(CtClass cls) {
            try {
                cls.getDeclaredConstructor(new CtClass[] { cls, fastr.pool.get("boolean") });
                return true;
            } catch (NotFoundException e) {
                return false;
            }
         ...
         */
        protected void injectCopyOrMoveConstructor(CtClass cls) throws NotFoundException, CannotCompileException {
            try {
                ...
                sb.append("}\n");
                try {
                    CtConstructor c = CtNewConstructor.make(new CtClass[] { cls, fastr.pool.get("boolean") }, null, sb.toString(), cls);
        ...
        protected void injectDeepCopyMethod(CtClass cls) throws CannotCompileException {
            CtMethod m = CtNewMethod.make("public "+NODE_BASE+" deepCopy() { return new "+cls.getName()+"(this, false); }",cls);
