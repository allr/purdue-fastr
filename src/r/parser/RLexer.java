// $ANTLR !Unknown version! R.g 2012-11-15 16:39:42
...
public class RLexer extends Lexer {
    ...
    public final void mNEWLINE() throws RecognitionException {
        try {
            int _type = NEWLINE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // R.g:424:2: ( LINE_BREAK )
            // R.g:424:4: LINE_BREAK
            {
            mLINE_BREAK(); 
             if(incomplete_stack[incomplete_depth]>0) _channel=HIDDEN; 
    ...
    public final void mINTEGER() throws RecognitionException {
        try {
            int _type = INTEGER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // R.g:426:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* 'L' | ( '.' )? ( '0' .. '9' )+ ( EXPONENT )? 'L' | '0x' ( HEX_DIGIT )+ 'L' )
            int alt12=3;
            ...
            switch (alt12) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // R.g:428:9: '0x' ( HEX_DIGIT )+ 'L'
                    {
                    match("0x"); 

                    // R.g:428:14: ( HEX_DIGIT )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=2;
    ...
    public final void mCOMPLEX() throws RecognitionException {
        try {
            int _type = COMPLEX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // R.g:431:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? 'i' | ( '.' )? ( '0' .. '9' )+ ( EXPONENT )? 'i' | '0x' HEX_DIGIT 'i' )
            int alt19=3;
            alt19 = dfa19.predict(input);
            switch (alt19) {
                case 1 :
                    // R.g:431:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? 'i'
                    {
                    // R.g:431:9: ( '0' .. '9' )+
                    int cnt13=0;
                    loop13:
    ...
    public final void mDOUBLE() throws RecognitionException {
        try {
            int _type = DOUBLE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // R.g:436:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | ( '.' )? ( '0' .. '9' )+ ( EXPONENT )? | '0x' HEX_DIGIT )
            int alt26=3;
            alt26 = dfa26.predict(input);
            switch (alt26) {
                case 1 :
                    // R.g:436:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )?
                    {
                    // R.g:436:9: ( '0' .. '9' )+
                    int cnt20=0;
                    loop20:
    ...
    public final void mSTRING() throws RecognitionException {
        try {
            ...
            // R.g:458:1: ( '\"' ( ESCAPE[buf] | i=~ ( '\\\\' | '\"' ) )* '\"' )
            // R.g:459:5: '\"' ( ESCAPE[buf] | i=~ ( '\\\\' | '\"' ) )* '\"'
            {
            match('\"'); 
            // R.g:460:5: ( ESCAPE[buf] | i=~ ( '\\\\' | '\"' ) )*
            loop32:
            do {
                int alt32=3;
    ...
    public final void mESCAPE(StringBuilder buf) throws RecognitionException {
        try {
            ...
            // R.g:468:36: ( '\\\\' ( 't' | 'n' | 'r' | 'b' | 'f' | '\"' | '\\\\' | 'x' a= HEX_DIGIT b= HEX_DIGIT | 'u' a= HEX_DIGIT b= HEX_DIGIT c= HEX_DIGIT d= HEX_DIGIT | 'U' a= HEX_DIGIT b= HEX_DIGIT c= HEX_DIGIT d= HEX_DIGIT e= HEX_DIGIT f= HEX_DIGIT g= HEX_DIGIT h= HEX_DIGIT ) )
            // R.g:469:5: '\\\\' ( 't' | 'n' | 'r' | 'b' | 'f' | '\"' | '\\\\' | 'x' a= HEX_DIGIT b= HEX_DIGIT | 'u' a= HEX_DIGIT b= HEX_DIGIT c= HEX_DIGIT d= HEX_DIGIT | 'U' a= HEX_DIGIT b= HEX_DIGIT c= HEX_DIGIT d= HEX_DIGIT e= HEX_DIGIT f= HEX_DIGIT g= HEX_DIGIT h= HEX_DIGIT )
            {
            match('\\'); 
            // R.g:470:5: ( 't' | 'n' | 'r' | 'b' | 'f' | '\"' | '\\\\' | 'x' a= HEX_DIGIT b= HEX_DIGIT | 'u' a= HEX_DIGIT b= HEX_DIGIT c= HEX_DIGIT d= HEX_DIGIT | 'U' a= HEX_DIGIT b= HEX_DIGIT c= HEX_DIGIT d= HEX_DIGIT e= HEX_DIGIT f= HEX_DIGIT g= HEX_DIGIT h= HEX_DIGIT )
            int alt33=10;
            switch ( input.LA(1) ) {
            case 't':
                {
            ...
            switch (alt33) {
                ...
                case 7 :
                    ...
                    break;
                case 8 :
                    // R.g:477:7: 'x' a= HEX_DIGIT b= HEX_DIGIT
                    {
                    match('x'); 
                    int aStart1154 = getCharIndex();
                    mHEX_DIGIT(); 
                    a = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, aStart1154, getCharIndex()-1);
                    int bStart1160 = getCharIndex();
                    mHEX_DIGIT(); 
                    b = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, bStart1160, getCharIndex()-1);
                     buf.append(ParseUtil.hexChar((a!=null?a.getText():null), (b!=null?b.getText():null))); 

                    }
                    break;
                case 9 :
                    // R.g:478:7: 'u' a= HEX_DIGIT b= HEX_DIGIT c= HEX_DIGIT d= HEX_DIGIT
                    {
                    match('u'); 
                    int aStart1176 = getCharIndex();
                    mHEX_DIGIT(); 
                    a = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, aStart1176, getCharIndex()-1);
                    int bStart1182 = getCharIndex();
                    mHEX_DIGIT(); 
                    b = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, bStart1182, getCharIndex()-1);
                    int cStart1188 = getCharIndex();
                    mHEX_DIGIT(); 
                    c = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, cStart1188, getCharIndex()-1);
                    int dStart1194 = getCharIndex();
                    mHEX_DIGIT(); 
                    d = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, dStart1194, getCharIndex()-1);
                     buf.append(ParseUtil.hexChar((a!=null?a.getText():null), (b!=null?b.getText():null), (c!=null?c.getText():null), (d!=null?d.getText():null))); 

                    }
                    break;
                case 10 :
                    // R.g:479:7: 'U' a= HEX_DIGIT b= HEX_DIGIT c= HEX_DIGIT d= HEX_DIGIT e= HEX_DIGIT f= HEX_DIGIT g= HEX_DIGIT h= HEX_DIGIT
                    {
                    match('U'); 
                    int aStart1210 = getCharIndex();
                    mHEX_DIGIT(); 
                    a = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, aStart1210, getCharIndex()-1);
                    int bStart1216 = getCharIndex();
                    mHEX_DIGIT(); 
                    b = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, bStart1216, getCharIndex()-1);
                    int cStart1222 = getCharIndex();
                    mHEX_DIGIT(); 
                    c = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, cStart1222, getCharIndex()-1);
                    int dStart1228 = getCharIndex();
                    mHEX_DIGIT(); 
                    d = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, dStart1228, getCharIndex()-1);
                    int eStart1234 = getCharIndex();
                    mHEX_DIGIT(); 
                    e = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, eStart1234, getCharIndex()-1);
                    int fStart1240 = getCharIndex();
                    mHEX_DIGIT(); 
                    f = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, fStart1240, getCharIndex()-1);
                    int gStart1246 = getCharIndex();
                    mHEX_DIGIT(); 
                    g = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, gStart1246, getCharIndex()-1);
                    int hStart1252 = getCharIndex();
                    mHEX_DIGIT(); 
                    h = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, hStart1252, getCharIndex()-1);
    ...
    public final void mID_NAME() throws RecognitionException {
        try {
            // R.g:498:2: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '.' )* )
            // R.g:498:4: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '.' )*
            {
    ...
    public final void mESC_SEQ() throws RecognitionException {
        try {
            // R.g:502:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '`' | '\\\\' | ' ' | 'a' | 'v' ) | '\\\\' LINE_BREAK | UNICODE_ESC | OCTAL_ESC | HEX_ESC )
            int alt41=5;
    ...
    public final void mUNICODE_ESC() throws RecognitionException {
        try {
            // R.g:510:5: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
            // R.g:510:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
            {
            match('\\'); 
            match('u'); 
            mHEX_DIGIT(); 
    ...
    public final void mHEX_ESC() throws RecognitionException {
        try {
            // R.g:514:2: ( '\\\\x' HEX_DIGIT ( HEX_DIGIT )? )
            // R.g:514:4: '\\\\x' HEX_DIGIT ( HEX_DIGIT )?
            {
            match("\\x"); 

            mHEX_DIGIT(); 
            // R.g:514:20: ( HEX_DIGIT )?
            int alt42=2;
    ...
    public final void mHEX_DIGIT() throws RecognitionException {
        try {
            // R.g:518:2: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // R.g:518:4: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    public final void mOCTAL_ESC() throws RecognitionException {
        try {
            // R.g:522:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt43=3;
    ...
    public void mTokens() throws RecognitionException {
        // R.g:1:8: ( T__86 | COMMENT | ARROW | SUPER_ARROW | RIGHT_ARROW | SUPER_RIGHT_ARROW | VARIATIC | EQ | NE | GE | LE | GT | LT | ASSIGN | NS_GET_INT | NS_GET | COLON | SEMICOLON | COMMA | AND | BITWISEAND | OR | BITWISEOR | LBRACE | RBRACE | LPAR | RPAR | LBB | LBRAKET | RBRAKET | CARRET | TILDE | MOD | NOT | PLUS | MULT | MAT_MULT | OUTER_MULT | DIV | MINUS | FIELD | AT | FUNCTION | NULL | NA | TRUE | FALSE | WHILE | FOR | REPEAT | IN | IF | ELSE | NEXT | BREAK | WS | NEWLINE | INTEGER | COMPLEX | DOUBLE | DD | ID | OP | STRING )
        int alt44=64;
    ...
    class DFA12 extends DFA {
        ...
        public String getDescription() {
            return "425:1: INTEGER : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* 'L' | ( '.' )? ( '0' .. '9' )+ ( EXPONENT )? 'L' | '0x' ( HEX_DIGIT )+ 'L' );";
        }
    }
    ...
    class DFA19 extends DFA {
        ...
        @Override
        public String getDescription() {
            return "430:1: COMPLEX : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? 'i' | ( '.' )? ( '0' .. '9' )+ ( EXPONENT )? 'i' | '0x' HEX_DIGIT 'i' );";
        }
    }
    ...
    class DFA26 extends DFA {
        ...
        @Override
        public String getDescription() {
            return "435:1: DOUBLE : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | ( '.' )? ( '0' .. '9' )+ ( EXPONENT )? | '0x' HEX_DIGIT );";
        }
    }
    static final String DFA44_eotS =
        "\1\uffff\1\55\1\uffff\1\61\1\63\1\51\1\67\1\71\1\73\2\uffff\1\75"+
        "\1\77\4\uffff\1\101\2\uffff\1\102\6\uffff\12\51\2\uffff\2\127\3"+
        "\uffff\1\133\5\uffff\1\135\2\uffff\1\127\21\uffff\3\51\1\145\4\51"+
        "\1\152\1\153\3\51\1\uffff\1\127\10\uffff\1\164\3\uffff\1\51\1\170"+
        "\1\51\1\uffff\4\51\2\uffff\3\51\2\127\2\uffff\1\127\3\uffff\1\51"+
    ...
    static final String DFA44_minS =
        ...
        "\uffff\1\72\1\uffff\1\56\1\60\16\uffff\2\45\1\uffff\1\156\1\162"+
        "\1\114\1\56\1\125\1\114\1\151\1\160\2\56\1\163\1\170\1\145\2\60"+
        "\1\53\7\uffff\1\56\3\uffff\1\143\1\56\1\114\1\uffff\1\105\1\123"+
        "\1\154\1\145\2\uffff\1\145\1\164\1\141\2\60\1\53\2\60\3\uffff\1"+
    ...
    static final String DFA44_maxS =
        ...
        "\1\76\5\uffff\1\72\1\uffff\1\172\1\151\16\uffff\2\176\1\uffff\1"+
        "\156\1\162\1\114\1\172\1\125\1\114\1\151\1\160\2\172\1\163\1\170"+
        "\1\145\1\146\1\151\1\71\7\uffff\1\172\3\uffff\1\143\1\172\1\114"+
        "\1\uffff\1\105\1\123\1\154\1\145\2\uffff\1\145\1\164\1\141\2\151"+
        "\2\71\1\151\3\uffff\1\164\1\uffff\2\172\1\105\1\145\1\141\2\172"+
        "\1\153\1\71\2\151\2\uffff\2\172\1\164\2\uffff\1\172\1\157\2\uffff"+
        "\1\172\1\uffff\1\156\1\uffff\1\172\1\uffff";
    static final String DFA44_acceptS =
        "\2\uffff\1\2\6\uffff\1\22\1\23\2\uffff\1\30\1\31\1\32\1\33\1\uffff"+
        "\1\36\1\37\1\uffff\1\40\1\uffff\1\43\1\47\1\51\1\52\12\uffff\1\70"+
        "\1\71\2\uffff\1\76\1\100\1\1\1\uffff\1\50\1\3\1\4\1\13\1\15\1\uffff"+
        "\1\21\2\uffff\1\10\1\16\1\11\1\42\1\12\1\14\1\24\1\25\1\26\1\27"+
        "\1\34\1\35\1\44\1\41\2\uffff\1\77\20\uffff\1\74\1\73\1\72\1\6\1"+
        "\5\1\17\1\20\1\uffff\1\75\1\45\1\46\3\uffff\1\55\4\uffff\1\63\1"+
        "\64\10\uffff\1\7\1\45\1\46\1\uffff\1\61\13\uffff\1\54\1\56\3\uffff"+
        "\1\65\1\66\2\uffff\1\57\1\60\1\uffff\1\67\1\uffff\1\62\1\uffff\1"+
        "\53";
    ...
    static final String[] DFA44_transitionS = {
            ...
            "\1\23",
            "",
            "\1\103\1\106\3\uffff\1\104\5\106\12\uffff\1\106\1\uffff\3\106"+
            "\2\uffff\32\106\3\uffff\2\106\1\uffff\16\106\1\105\13\106\1"+
            "\uffff\1\106\1\uffff\1\106",
            "",
            "",
            "",
            ...
            "",
            "",
            "\1\125\1\uffff\12\50\13\uffff\1\126\6\uffff\1\131\30\uffff"+
            "\1\126\3\uffff\1\130\16\uffff\1\124",
            "\1\125\1\uffff\12\50\13\uffff\1\126\6\uffff\1\131\30\uffff"+
            "\1\126\3\uffff\1\130",
            "",
            "",
            ...
            "\1\134",
            "",
            "\1\136\1\uffff\12\137\7\uffff\32\51\4\uffff\1\51\1\uffff\32"+
            "\51",
            ...
            "",
            "",
            "\1\140\1\106\3\uffff\6\106\12\uffff\1\106\1\uffff\3\106\2\uffff"+
            "\32\106\3\uffff\2\106\1\uffff\32\106\1\uffff\1\106\1\uffff\1"+
            "\106",
            "\1\141\1\106\3\uffff\21\106\1\uffff\3\106\2\uffff\32\106\3"+
            "\uffff\2\106\1\uffff\32\106\1\uffff\1\106\1\uffff\1\106",
            "",
            "\1\142",
            "\1\143",
            "\1\144",
            ...
            "\12\160\13\uffff\1\161\6\uffff\1\131\30\uffff\1\161\3\uffff"+
            "\1\130",
    ...
    class DFA44 extends DFA {
        ...
        @Override
        public String getDescription() {
            return "1:1: Tokens : ( T__86 | COMMENT | ARROW | SUPER_ARROW | RIGHT_ARROW | SUPER_RIGHT_ARROW | VARIATIC | EQ | NE | GE | LE | GT | LT | ASSIGN | NS_GET_INT | NS_GET | COLON | SEMICOLON | COMMA | AND | BITWISEAND | OR | BITWISEOR | LBRACE | RBRACE | LPAR | RPAR | LBB | LBRAKET | RBRAKET | CARRET | TILDE | MOD | NOT | PLUS | MULT | MAT_MULT | OUTER_MULT | DIV | MINUS | FIELD | AT | FUNCTION | NULL | NA | TRUE | FALSE | WHILE | FOR | REPEAT | IN | IF | ELSE | NEXT | BREAK | WS | NEWLINE | INTEGER | COMPLEX | DOUBLE | DD | ID | OP | STRING );";
        }
    }
