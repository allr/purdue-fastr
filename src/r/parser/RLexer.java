// $ANTLR 3.5 R.g 2013-03-06 16:25:40
...
public class RLexer extends Lexer {
	...
	public final void mSTRING() throws RecognitionException {
		try {
			...
			// R.g:451:5: ( ( '\\\"' ( ESCAPE[buf] |i=~ ( '\\\\' | '\"' ) )* '\\\"' ) | ( '\\'' ( ESCAPE[buf] |i=~ ( '\\\\' | '\\'' ) )* '\\'' ) )
			int alt35=2;
	...
	public final void mID_NAME() throws RecognitionException {
		try {
			// R.g:505:2: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '.' )* )
			// R.g:505:4: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '.' )*
			{
	...
	public final void mESC_SEQ() throws RecognitionException {
		try {
			// R.g:509:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '`' | '\\\\' | ' ' | 'a' | 'v' ) | '\\\\' LINE_BREAK | UNICODE_ESC | OCTAL_ESC | HEX_ESC )
			int alt44=5;
	...
	public final void mUNICODE_ESC() throws RecognitionException {
		try {
			// R.g:517:5: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			// R.g:517:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
			{
			match('\\'); 
			match('u'); 
			mHEX_DIGIT(); 
	...
	public final void mHEX_ESC() throws RecognitionException {
		try {
			// R.g:521:2: ( '\\\\x' HEX_DIGIT ( HEX_DIGIT )? )
			// R.g:521:4: '\\\\x' HEX_DIGIT ( HEX_DIGIT )?
			{
			match("\\x"); 

			mHEX_DIGIT(); 

			// R.g:521:20: ( HEX_DIGIT )?
			int alt45=2;
	...
	public final void mOCTAL_ESC() throws RecognitionException {
		try {
			// R.g:529:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
			int alt46=3;
