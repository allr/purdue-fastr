...
public class EnvironmentImpl extends BaseObject implements REnvironment {
    ...
    @Override public void assign(RSymbol name, RAny value, boolean inherits, ASTNode ast) {
        if (!inherits) {
    ...
    @Override public RAny get(RSymbol name, boolean inherits) {
        if (!inherits) {
    ...
    @Override public boolean exists(RSymbol name, boolean inherits) {
        if (!inherits) {
    ...
    @Override public RCallable match(RSymbol name) {
        return RFrameHeader.match(frame, name);
    }

    @Override public RSymbol[] ls() {
