...
public final class RFrame extends Frame {
    ...
    public void writeInExtension(RSymbol sym, RAny value) {
        ...
        if (ext == null) {
            ...
            ext.put(sym, value); // The extension is brand new, we can use the first slot safely
        } else {
    ...
    private static class RFrameExtension {
        ...
        private int hashBlossom; // This comes from Alex B. (?)
        ...
        private void put(RSymbol sym, RAny val) {
            int pos = used;
            if (pos == capacity) {
                expand(capacity * 2);
            }
